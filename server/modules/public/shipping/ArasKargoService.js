...
class ArasKargoService extends BaseShippingService {
  ...
  async getShippingRates(packageInfo, fromAddress, toAddress) {
    try {
      ...
      this.logger.error(
        `Failed to get Aras Kargo shipping rates: ${error.message}`,
        { error }
      );
      return this.createErrorResponse(
  ...
  async createShippingLabel(shipmentData) {
    try {
      ...
      this.logger.error(
        `Failed to create Aras Kargo shipping label: ${error.message}`,
        { error }
      );
      return this.createErrorResponse(
  ...
  async trackPackage(trackingNumber) {
    try {
      ...
      this.logger.error(
        `Failed to track Aras Kargo package: ${error.message}`,
        { error }
      );
      return this.createErrorResponse(
  ...
  async cancelShipment(trackingNumber) {
    try {
      ...
      this.logger.error(
        `Failed to cancel Aras Kargo shipment: ${error.message}`,
        { error }
      );
      return this.createErrorResponse(
  ...
  async checkDeliveryAvailability(address) {
    try {
      ...
      this.logger.error(
        `Failed to check Aras Kargo delivery availability: ${error.message}`,
        { error }
      );
      return this.createErrorResponse(
