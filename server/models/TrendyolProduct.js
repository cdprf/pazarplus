...
TrendyolProduct.init(
  {
    ...
    trendyolProductId: {
      ...
      allowNull: false,
      unique: true,
      comment: 'Trendyol product ID (internal ID from API)'
    },
    externalProductId: {
      type: DataTypes.STRING,
      allowNull: true,
    ...
    brandId: {
      ...
      allowNull: true,
      comment: 'Trendyol brand ID (numeric)'
    },
    categoryName: {
      type: DataTypes.STRING,
      allowNull: true,
    ...
    categoryId: {
      type: DataTypes.INTEGER,
      allowNull: true,
      comment: 'Trendyol category ID (pimCategoryId)'
    },
    quantity: {
      type: DataTypes.INTEGER,
      allowNull: false,
    ...
    productCode: {
      ...
      allowNull: true,
      comment: 'Trendyol product code (numeric from API)'
    },
    productContentId: {
      type: DataTypes.BIGINT,
      allowNull: true,
      comment: 'Trendyol product content ID (numeric)'
    },
    productMainId: {
      type: DataTypes.STRING,
      allowNull: true,
    ...
    pimCategoryId: {
      type: DataTypes.INTEGER,
      allowNull: true,
      comment: 'Trendyol PIM category ID (numeric)'
    },
    supplierId: {
      type: DataTypes.INTEGER,
      allowNull: true,
      comment: 'Trendyol supplier ID (numeric)'
    },
    platformListingId: {
      type: DataTypes.STRING,
      allowNull: true,
