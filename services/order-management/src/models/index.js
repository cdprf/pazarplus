...
const PlatformConnectionModel = require('./platform-connection.model');
...
const User = UserModel.init(sequelize); // Initialize User model with sequelize instance
const PlatformConnection = PlatformConnectionModel.init(sequelize); // Initialize PlatformConnection with sequelize
