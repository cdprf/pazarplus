...
if (!projectPath) {
  console.log('❌ Could not find project directory. Please run this script from your project root.');
  process.exit(1);
}
...
fs.writeFileSync(testFile, 'VPS PDF fix test file - ' + new Date().toISOString());
...
if (envContent.includes('SERVER_BASE_URL=') && !envContent.includes('#SERVER_BASE_URL=')) {
...
console.log('Choose one of these commands based on how you\'re running the app:');
console.log('');
