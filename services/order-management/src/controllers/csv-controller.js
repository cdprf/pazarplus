...
class CSVController {
  ...
  initializeRoutes() {
    ...
    this.router.post('/validate', upload.single('file'), this.validateCSV);
    this.router.post('/import/:connectionId', upload.single('file'), this.importCSV);
    this.router.get('/templates', this.getTemplates);
  }
