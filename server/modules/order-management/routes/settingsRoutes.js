...
// QNB Finans settings routes
router.get("/qnb-finans", settingsController.getQNBFinansSettings);
router.post("/qnb-finans", settingsController.saveQNBFinansSettings);
router.post("/qnb-finans/test", settingsController.testQNBFinansConnection);
