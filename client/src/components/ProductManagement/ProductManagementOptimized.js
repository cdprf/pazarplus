        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="form-group">
            ...
            <small className="form-help">
              Platform senkronizasyonu için kullanılır
            </small>
          </div>
      ...
      {activeTab === "details" && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="form-group md:col-span-2">
            ...
            />
            <small className="form-help">
              Ürünü kategorize etmek için etiketler ekleyin
            </small>
          </div>
        </div>
      )}
        ...
        <div className="space-y-4">
          ...
          <div className="bg-yellow-50 dark:bg-yellow-900/20 p-4 rounded-lg">
            <p className="text-sm text-yellow-700 dark:text-yellow-300">
              ⚠️ Platform ayarları sadece bilgilendirme amaçlıdır. Gerçek
              senkronizasyon ayarları platform bağlantı yönetimi bölümünden
              yapılır.
            </p>
          </div>
        </div>
