...
class ShippingController {
  ...
  initializeRoutes() {
    ...
    this.router.post('/labels/generate', this.generateShippingLabel);
    this.router.post('/labels/bulk', this.generateBulkShippingLabels);
    this.router.get('/labels/:id', this.getShippingLabel);
    
    // Shipping status routes
    this.router.post('/mark-shipped', this.markAsShipped);
    this.router.get('/carriers', this.getSupportedCarriers);
  }
  ...
  async generateBulkShippingLabels(req, res) {
    try {
