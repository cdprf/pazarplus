...
User.hasMany(PlatformConnection, { foreignKey: 'userId', as: 'platformConnections' });
PlatformConnection.belongsTo(User, { foreignKey: 'userId', as: 'user' });

Order.belongsTo(ShippingDetail, { foreignKey: 'shippingDetailId', as: 'shippingDetail' });
...
Order.belongsTo(PlatformConnection, { foreignKey: 'connectionId', as: 'platformConnection' });

// Platform-specific order associations
Order.hasOne(HepsiburadaOrder, { foreignKey: 'orderId', as: 'hepsiburadaOrder' });
...
ShippingRate.belongsTo(ShippingCarrier, { foreignKey: 'carrierId', as: 'carrier' });
...
ShippingDetail.belongsTo(ShippingCarrier, { foreignKey: 'carrierId', as: 'carrier' });
ShippingCarrier.hasMany(ShippingDetail, { foreignKey: 'carrierId', as: 'shipments' });

// Turkish compliance associations
Order.hasOne(TurkishCompliance, { foreignKey: 'orderId', as: 'turkishCompliance' });
