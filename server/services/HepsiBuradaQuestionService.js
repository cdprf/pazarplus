...
class HepsiBuradaQuestionService {
  ...
  async answerQuestion(issueNumber, answerText, attachments = []) {
    try {
      ...
      // Add the answer text with correct parameter name
      ...
      debug("Request data:", { Answer: answerText, Files: attachments });
      ...
      return {
        success: response.status === 201, // Changed to 201 as per documentation
