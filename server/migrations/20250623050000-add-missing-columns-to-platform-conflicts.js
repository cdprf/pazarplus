...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    await queryInterface
      .addColumn("platform_conflicts", "platform", {
        type: "platform_enum",
        allowNull: false,
    ...
    await queryInterface
      .addColumn("platform_conflicts", "localEntityId", {
    ...
    await queryInterface
      .addColumn("platform_conflicts", "severity", {
        type: "severity_enum",
        allowNull: true,
        defaultValue: "medium",
      })
    ...
    await queryInterface
      .addColumn("platform_conflicts", "autoResolvable", {
    ...
    await queryInterface
      .addColumn("platform_conflicts", "resolutionStrategy", {
    ...
    await queryInterface
      .addColumn("platform_conflicts", "resolutionData", {
    ...
    await queryInterface
      .addColumn("platform_conflicts", "resolutionNotes", {
        type: Sequelize.TEXT,
        allowNull: true,
      })
      .catch((error) => {
    ...
    await queryInterface
      .addColumn("platform_conflicts", "syncSessionId", {
        type: Sequelize.UUID,
        allowNull: true,
      })
      .catch((error) => {
    ...
    await queryInterface
      .addColumn("platform_conflicts", "detectedAt", {
        type: Sequelize.DATE,
        allowNull: true,
    ...
    await queryInterface
      .addColumn("platform_conflicts", "lastUpdated", {
        type: Sequelize.DATE,
        allowNull: true,
        defaultValue: Sequelize.NOW,
      })
    ...
    await queryInterface
      .addColumn("platform_conflicts", "metadata", {
        type: Sequelize.JSONB,
        allowNull: true,
        defaultValue: {},
      })
    ...
    await queryInterface
      .addIndex("platform_conflicts", ["platform", "status"], {
        name: "platform_conflicts_platform_status",
      })
      .catch((error) => {
        if (error.message.includes("already exists")) {
          console.log(
            "Index platform_conflicts_platform_status already exists"
          );
        } else {
          throw error;
        }
    ...
    await queryInterface
      .addIndex("platform_conflicts", ["conflictType", "severity"], {
        name: "platform_conflicts_conflictType_severity",
      })
      .catch((error) => {
        if (error.message.includes("already exists")) {
          console.log(
            "Index platform_conflicts_conflictType_severity already exists"
          );
        } else {
          throw error;
        }
    ...
    await queryInterface
      .addIndex("platform_conflicts", ["entityType", "entityId"], {
        name: "platform_conflicts_entityType_entityId",
      })
      .catch((error) => {
        if (error.message.includes("already exists")) {
          console.log(
            "Index platform_conflicts_entityType_entityId already exists"
          );
        } else {
          throw error;
        }
    ...
    await queryInterface
      .addIndex("platform_conflicts", ["syncSessionId"], {
    ...
    await queryInterface
      .addIndex("platform_conflicts", ["detectedAt"], {
    ...
    await queryInterface
      .addIndex("platform_conflicts", ["resolvedBy"], {
  ...
  down: async (queryInterface, Sequelize) => {
    // Remove all indexes
    await queryInterface
      .removeIndex("platform_conflicts", "platform_conflicts_platform_status")
      .catch((e) => console.log("Failed to remove index:", e.message));
    await queryInterface
      .removeIndex(
        "platform_conflicts",
        "platform_conflicts_conflictType_severity"
      )
      .catch((e) => console.log("Failed to remove index:", e.message));
    await queryInterface
      .removeIndex(
        "platform_conflicts",
        "platform_conflicts_entityType_entityId"
      )
      .catch((e) => console.log("Failed to remove index:", e.message));
    await queryInterface
      .removeIndex("platform_conflicts", "platform_conflicts_syncSessionId")
      .catch((e) => console.log("Failed to remove index:", e.message));
    await queryInterface
      .removeIndex("platform_conflicts", "platform_conflicts_detectedAt")
      .catch((e) => console.log("Failed to remove index:", e.message));
    await queryInterface
      .removeIndex("platform_conflicts", "platform_conflicts_resolvedBy")
      .catch((e) => console.log("Failed to remove index:", e.message));

    // Remove all added columns
    await queryInterface
      .removeColumn("platform_conflicts", "platform")
      .catch((e) => console.log("Failed to remove column:", e.message));
    await queryInterface
      .removeColumn("platform_conflicts", "localEntityId")
      .catch((e) => console.log("Failed to remove column:", e.message));
    await queryInterface
      .removeColumn("platform_conflicts", "severity")
      .catch((e) => console.log("Failed to remove column:", e.message));
    await queryInterface
      .removeColumn("platform_conflicts", "autoResolvable")
      .catch((e) => console.log("Failed to remove column:", e.message));
    await queryInterface
      .removeColumn("platform_conflicts", "resolutionStrategy")
      .catch((e) => console.log("Failed to remove column:", e.message));
    await queryInterface
      .removeColumn("platform_conflicts", "resolutionData")
      .catch((e) => console.log("Failed to remove column:", e.message));
    await queryInterface
      .removeColumn("platform_conflicts", "resolutionNotes")
      .catch((e) => console.log("Failed to remove column:", e.message));
    await queryInterface
      .removeColumn("platform_conflicts", "syncSessionId")
      .catch((e) => console.log("Failed to remove column:", e.message));
    await queryInterface
      .removeColumn("platform_conflicts", "detectedAt")
      .catch((e) => console.log("Failed to remove column:", e.message));
    await queryInterface
      .removeColumn("platform_conflicts", "lastUpdated")
      .catch((e) => console.log("Failed to remove column:", e.message));
    await queryInterface
      .removeColumn("platform_conflicts", "metadata")
      .catch((e) => console.log("Failed to remove column:", e.message));

    // Drop enum types
    await queryInterface.sequelize
      .query("DROP TYPE IF EXISTS platform_enum;")
      .catch((e) => console.log("Failed to drop type:", e.message));
    await queryInterface.sequelize
      .query("DROP TYPE IF EXISTS severity_enum;")
      .catch((e) => console.log("Failed to drop type:", e.message));
    await queryInterface.sequelize
      .query("DROP TYPE IF EXISTS resolution_strategy_enum;")
      .catch((e) => console.log("Failed to drop type:", e.message));
  },
};
