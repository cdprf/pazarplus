...
const config = {
  ...
  platforms: {
    trendyol: {
      ...
      sandboxUrl: process.env.TRENDYOL_SANDBOX_URL || 'https://api.trendyol.com/sapigw/sandbox'
    },
    n11: {
      apiUrl: process.env.N11_API_URL || 'https://api.n11.com/ws',
      sandboxUrl: process.env.N11_SANDBOX_URL || 'https://api.n11.com/ws/sandbox'
    },
    hepsiburada: {
      apiUrl: process.env.HEPSIBURADA_API_URL || 'https://api.hepsiburada.com',
      sandboxUrl: process.env.HEPSIBURADA_SANDBOX_URL || 'https://api.hepsiburada.com/sandbox'
    }
  },
